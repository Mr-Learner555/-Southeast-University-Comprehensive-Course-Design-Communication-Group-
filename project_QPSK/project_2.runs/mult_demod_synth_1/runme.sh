...
HD_PWD='D:/Final Homework/project_2/project_2.runs/mult_demod_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_demod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_demod.tcl
