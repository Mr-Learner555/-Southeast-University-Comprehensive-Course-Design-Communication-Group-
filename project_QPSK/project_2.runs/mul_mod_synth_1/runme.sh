...
HD_PWD='D:/Final Homework/project_2/project_2.runs/mul_mod_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_mod.tcl
