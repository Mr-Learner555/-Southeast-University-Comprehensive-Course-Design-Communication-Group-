...
HD_PWD='D:/Final Homework/project_2/project_2.runs/mult_interpolate_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_interpolate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_interpolate.tcl
