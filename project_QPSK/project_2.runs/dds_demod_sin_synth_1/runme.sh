...
HD_PWD='D:/Final Homework/project_2/project_2.runs/dds_demod_sin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_demod_sin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_demod_sin.tcl
